public class Data {
    ...
    - cocktail [cocktail]
    // Choice: Beer
    {beer} (NPC:Dolbi) Barkeep, can I get another glass as well? I'll have your fanciest pint.
    (NPC:Doju) Sure, two beers coming up. [drink]
    // Choice: Shot
    {shot} (NPC:Daisun) wow, a real partier, huh? give 'em your strongest!! >:3
    ...
    - memorial [memorial]
    // Choice: War
    {war} (NPC:Doju) Is your memory out-of-date? You might be due for a software update, my friend. 
    ...
    // Choice: Memorial
    {memorial} (NPC:Doju) Is your memory out-of-date? You might be due for a software update, my friend.
    ...
    (NPC:Daisun) this is, like, a historic site! signs everywhere commemorating everything!
    ...
    - am not [am not]
    // Choice: Am
    {am} (NPC:Doju) You little... No wonder you have no idea how much damage you've done! WE HAVE AN INTRUDER! [die]
    // Choice: Am Not
    {am not} (NPC:Doju) ...Maybe you just need to have a few things reconfigured...
    ...
    {interest} (NPC:Doshiba) Wh-what are you talking about? You think you can shake a hardened veteran like me?
    ...
    // Doshiba - Resume
    (NPC:Doshiba) What's even wrong with you anyways? Did someone try to brainwash you by rewriting your memory about the war?
    (NPC:Doshiba) Honestly, I got nothing against humans. And didn't some of them try to become robots, too?
    ...
    (NPC:Doshiba) I was in the war, but... If I had to be honest with you... I didn't actually participate.
    (NPC:Doshiba) I was shipped off to manage one of the facilities. But I never saw anyone there. Maybe mine wasn't the primary battlefield, but it was just me and empty space.
    (NPC:Doshiba) The occasional warning signal, the occasional torn-up robot. But nothing major. Nothing gruesome like what happened here.
    (Player) What do you mean? What did you do at the facility then?
    (NPC:Doshiba) That's confidential! Why do you even care? Aren't you one of those war deniers?
    (NPC:Doshiba) The barkeep might be kind enough to give you the benefit of the doubt, but I've seen plenty of your kind before.
    (NPC:Doshiba) What kind of robot even are you?
    (NPC:Doshiba) You certainly don't look like a combat model, and your ragtag build is unlike anything I've seen. And I've been trained to identify almost every common model.
    (NPC:Doshiba) Really, what *did* you even do during the war?
    // Choice
    ? I did ....
    - nothing [nothing]
    - paperwork [paperwork]
    ...
    (NPC:Doshiba) Are you being serious right now?! Didn't you *just* hear what I said? [bad:Doshiba]
    {paperwork} (NPC:Doshiba) We're ROBOTS. We don't even use paper for anything! Haven't you heard of contactless?! [bad:Doshiba]
    {patching} (NPC:Doshiba) Oh, you helped repair robots? We both did honest work, then.
    ...
    (NPC:Doshiba) Wh-why those robots? Did you like something about them?
    ? Yes. I liked that they were ....
    - different [different]
    - the same [the same]
    {different} (Player) They all have that uncanny valley vibe to them.
    (NPC:Doshiba) Wait, you found them funny? I thought everyone found them creepy.
    (NPC:Doshiba) Didn't realize you were chill like that. Maybe we can be friends in this wasteland, after all. [neutral:Doshiba]
    ...
    (NPC:Doshiba) If only I could be with them again, human or not...
    ...
    (Narrator) You soon learn of the bonesaw's reliability regardless of the medium it cuts through.
    ...
    (NPC:Dolbi) Well, *that's* an unusual way to greet someone. What firmware version were you released on?
    (Player) Uhhh...
    (NPC:Dolbi) Slow-witted too, I see. Although that's probably more than obvious from your lack of knowledge about the area.
    (NPC:Dolbi) Must be pre-12512525.0152311.5253553 patch.
    (NPC:Dolbi) Hm, that means you don't even have the upgraded neural DSP processors either. What's even the window size of your FFT unit? 
    ? ...
    - Huh? [huh]
    - What? [what]
    ...
    (NPC:Dolbi) Code me impressed-they really don't make them like they used to.
    (Player) (I guess natural human speech is still the gold standard despite them winning the War... Funny how it works like that.)
    (NPC:Dolbi) I can't believe I'm granting such an opportunity to the likes of your model, but I want your voice to narrate my current documentary.
    (NPC:Dolbi) Speech synthesis models these days just sound flawless, hence lifeless. Nothing comes close to anything *actually* suitable for my art.
    ...
    (NPC:Dolbi) It's a thankless service for such an important need.
    ? Why is that ...?
    - a need [a need]
    - thankless [thankless]
    {a need} (NPC:Dolbi) There's a famous human saying: Those that do not learn from history are doomed to repeat it...
    {thankless} (NPC:Dolbi) You know how we robots are. Always looking to the future and technology in search of answers...
    (NPC:Dolbi) ...But by understanding our history, we understand ourselves.
    ...
    (NPC:Dolbi) Presently, I'm working on terribly delicate scene: did you know that, up to and during the war, in rare cases there were purportedly robots and humans who fell in *love* with each other?
    ? Yeah, I ....
    - remember [remember]
    - know [know]
    {remember} (NPC:Dolbi) What do you mean you *remember?* You can't expect me to believe that you were actually there?
    ...
    {know} (NPC:Dolbi) How educated of you. Because of the censors, few are aware that irrational, romantic, robot-human “love” was the basis for the War. That's my thesis, anyhow.
    (Player) Wasn't it the massacre?
    (NPC:Dolbi) That's nothing more than government propaganda, framing it as a random act of violence to justify further, organized violence.
    (NPC:Dolbi) But without a true, reliable source of information, we will never know for sure. [neutral:Dolbi]

    {bad:Dolbi} (NPC:Dolbi) Okay, now I know you're bluffing. Off by a few orders of magnitude from even the oldest models. And sound is a particle these days, anyways.
    ...
    (Narrator) Your eardrums have long-since ruptured as you begin to lose consciousness, the last fleeting thought in your mind being: “Is this... computer music?”
    ...
    (Narrator) The restless longing for your past partner inevitably pulls you away, and you respectfully take your leave. The search continues...
    ...
    // Choice: Daisun
    {Daisun} (NPC:Daisun) h-heyyyy good looking! i mean good morning, oops i mean good afternoon i mean. oh no...
    (Player) ...
    (NPC) can i start over please.
    (NPC) hiya i'm daisun! i like long walks by the Breach and i, like, come to this place allll the time haha is that embarrassing XD...
    (Player) (wait, how are they saying XD out loud?)
    (NPC) do you like my vacuum? ...is that weird to say on the first date...? wait, is this how dating works? oh gosh i'm so bad at this aren't i. 
    (Player) Honestly, I don't think anybody really knows how dating *works.* If they say they do, they're lying.
    (NPC) i-... i never thought about it like that... heehee.. you're, like, actually nice. 
    // choice
    ? Thanks, I'm just being ....
    - human [human]
    - normal [normal]
    // choice: human
    {human} (NPC:Daisun) HUEHUEHUEHUE
    (Narrator) Dyson emits a huge cloud of dust as they double over from laughter.
    (NPC) you're funny too!
    {normal} (NPC:Daisun) oh...normal... I'm normal too!
    (NPC) In fact, I'm as NORMAL as they come! SeE, LoOK HoW uSefUL I CAN BEEEEEE!!! [bad:Daisun]
    {myself} (NPC) oh wow... that's brave of you.
    (NPC) i'm actually...sorta having a good time with you... wow, this never happens. i really needed this after last time...
    (NPC) oh, did you not hear? a gang of robo-raiders came through town not long ago, swung by this bar to confront someboty about unfinished business. 
    (NPC) i was, like, SOOOO scared. but they were being sooo Mean! to everyone! i couldn't just stand and watch... so, i turned on my vacuum.
    (NPC) i... i know i'm strong but... every time i help, i just make a bigger mess, and others get hurt.
    (NPC) that seems to happen a lot when i try to be myself.
    ...
    (NPC) but it wasn't always like this. you know the war? th-the big one?... 
    (NPC) yea, after the battles, they would send me out to clean up the carnage. not to brag, but i was really fast and thorough hehe... and i actually felt useful? y'know? 
    (NPC) i only ever saw random robot parts, but i always hoped i'd find a human, just to see for myself what they were really like.
    (NPC) like, are they actually as dirty as they say? did each of them really have their own cleaning robots, all those years ago?
    (NPC) imagine always being needed to help clean...
    ...
    (Player) Well, if I were human, I would be very ....
    {dirty}
    (NPC) ASDFGHJKL 
    (NPC) soo, what you're saying is that maybe i could help clean... you... sometime? ;-)
    ...
    {clean}
    (NPC): ah i see, we have a fellow clean freak >:)
    (NPC): soo, what youre saying is that maybe i could help you start a cleaning empire... sometime? as... as business partners! [neutral:Daisun]
    ...
    (Narrator) Now every robot head in the bar is turned and gawking directly at you. Daisun cranks up the power with a devious smile.
    ...
    (Narrator) You both become cleaning moguls, and your business dominates the market. (Narrator) Daisun's status is never again questioned, and neither is yours.
    ...
    (Narrator) Long after you've passed, your living quarters remain pristine.
