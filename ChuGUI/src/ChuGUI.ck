...
public class ChuGUI extends GGen {
    ...
    fun void debugAdd(string customId) {
        ...
        // For pooled components, use render order position
        internalId != "" ? internalId : (_lastComponentType + "_" + _debugAddCallCount) => string overrideId;

        // Increment call counter for next pooled component
        _debugAddCallCount++;
